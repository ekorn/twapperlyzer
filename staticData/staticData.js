var staticArchive = {"archive_info":
  {"id":"1",
  "keyword":"#knowaan",
  "description":"Tweets from project group knowAAN at UPB","tags":"",
  "screen_name":"aandev",
  "user_id":"85836202",
  "count":"36",
...
shortUrls  = [ { text: 'http://ur1.ca/2ll0s', weight: 2 },
  { text: 'http://t.co/z8fvYvQ', weight: 6 },
  { text: 'http://t.co/DBdNyxj', weight: 1 },
  { text: 'http://t.co/mneJKQo', weight: 14 },
  { text: 'http://t.co/QONWdJk', weight: 1 },
  { text: 'http://t.co/OE1aEsC', weight: 1 },
  { text: 'http://ur1.ca/4qdu8', weight: 2 },
  { text: 'http://t.co/HG8INyE', weight: 14 },
  { text: 'http://bit.ly/p7Au49', weight: 2 },
  { text: 'http://tinyurl.com/6ecjf9u', weight: 1 },
  { text: 'http://t.co/cYwSRSW', weight: 1 } ];
