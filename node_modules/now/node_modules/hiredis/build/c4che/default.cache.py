...
CPPPATH_NODE = '/home/ekorn/local/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-Wall', '-O3']
...
LIBDIR = '/home/ekorn/.node_libraries'
LIBPATH_HIREDIS = 'default'
LIBPATH_NODE = '/home/ekorn/local/lib'
LIBPATH_ST = '-L%s'
LIB_HIREDIS = 'hiredis'
LIB_ST = '-l%s'
...
LINK_CC = ['/usr/bin/gcc']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/ekorn/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/home/ekorn/local'
